...
bool ScollManager::Finished() const {
...
void ScollManager::RecalculateImages() {
...
void ScollManager::RecalculateHundredsLines() {
...
void ScollManager::RecalculateTensLines() {
...
uint8_t ScollManager::Hundreds(int8_t number) {
  return abs(number) / 100;
}

uint8_t ScollManager::Tens(int8_t number) {
  return (abs(number) % 100) / 10;
}

uint8_t ScollManager::Ones(int8_t number) {
